...
// generate 6 1uA bias sources
  for (i=0;i<6;i=i+1) begin
      // Each loop of the genblock must instantiate an instance of Isrc
      // The ival input should be the corresponding value of iref1Src
  end

// generate 4 5uA bias sources
  for (j=0;j<4;j=j+1) begin
      // Each loop of the genblock must instantiate an instance of Isrc
      // The ival input should be the corresponding value of iref5Src
   end
...
// The supply checks must be updated since VDD and VSS are now UDNs.
// The update is much simpler than the VAMS version
// write the appropriate always @ blocks.
...
// Don't forget to update the output for VREF ....
