...
parameter real L=1e-3, C=0.2e-6, Ts=2e-6,  // inductor, capacitor, sample period
               Tsw=20e-9, Tr=20e-9,        // switch & testbench risetimes
               Rsw=0.1, Rd=0.1, Roff=1e9;  // switch & diode on & off resistances
