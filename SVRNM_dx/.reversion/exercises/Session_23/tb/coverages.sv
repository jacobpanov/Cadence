...
//  <<<< Your coverpoints here >>>>

   option.comment = "********************* PLL Block Coverage *********************";
endgroup

PLL_coverage PLLcov = new;   // instantiate the covergroup
...
VCO_coverage VCOcov = new;  // instantiate the covergroup

endmodule

module coverages ();

//  <<<< Bind covPLL to PLL_top >>>>>>>


//  <<<< Bind covVCO to vco_rf  >>>>>>>
