...
module PLL_top import cds_rnm_pkg::*; import EE_pkg::*; 
   (adcClkn, adcClkp, div_outm, 
...
xorPhDet IPhDet ( .resetb(en), .vss(vss), .vdd(vdd), 
...
loopFilter ILF ( .trim(lfTrim), .preChg(lfPreChg), .lock(pllLock), 
