...
module PLL_stimulus
  ...
  initial begin
     ...
     //  Filter offset accessed at tb.u_PLLtop.ILF.fPoleError
     //  VCO offset accessed at tb.u_PLLtop.IVCO.fNomOffset
     //  <<<< Your Code Here >>>>
  ...
  // Immediate assertion to check current drain
  //    <<<< Your Code Here >>>>

       #(280e-6) PLL_EN = 1'b0;
       #(280e-6) REFCLK_EN = 1'b0;
