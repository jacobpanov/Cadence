...
import cds_rnm_pkg::*;
import EE_pkg::*;
// import the package containing the filte randomization class
import modelError::*;
...
module PLL_stimulus
  ...
  initial begin
   ...
   $display("**                                                               **");
   $display("**    PLL Coverage   = %f                                 **", tb.u_PLLtop.cv_PLLcov.PLLcov.get_coverage());
   $display("**      VCO vtune    = %f                                 **", tb.u_PLLtop.IVCO.cv_VCOcov.VCOcov.get_coverage());
   $display("**                                                               **");
   $display("*****************  Report Ends  ***********************************");
   $finish;
