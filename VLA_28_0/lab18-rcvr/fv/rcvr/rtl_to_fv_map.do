...
# Generated on: Thu Mar 13 20:00:59 EDT 2025 (Fri Mar 14 00:00:59 UTC 2025)
...
set logfile fv/rcvr/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/rcvr -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/software/commercial/cadence/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/software/commercial/cadence/GENUS211/tools.lnx86"
set env(CW_DIR) "/software/commercial/cadence/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/software/commercial/cadence/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /software/commercial/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/software/commercial/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/software/commercial/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/software/commercial/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/software/commercial/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path . /software/commercial/cadence/GENUS211/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    /software/commercial/cadence/GENUS211/share/synth/tutorials/tech/tutorial.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k rcvr.v
elaborate_design -golden -root {rcvr} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/rcvr/fv_map.v.gz
elaborate_design -revised -root {rcvr}
...
#add_name_alias fv/rcvr/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.rcvr.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.rcvr.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.rcvr.rtl.fv_map.rpt
