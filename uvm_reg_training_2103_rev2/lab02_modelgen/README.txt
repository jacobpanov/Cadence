...
reg_verifier -domain uvmreg -top yapp_registers_2-0.xml -dut_name yapp_registers -top_level_class_name yapp_router_regs_t -out_file yapp_router_regs -cov -quicktest -pkg yapp_router_reg_pkg

where:
-domain uvmreg creates a UVM register model
-top yapp_registers)2-0.xml is the IP-XACT register definition file
-dut_name is yapp_registers, the name of the top level component in the IP-XACT file
