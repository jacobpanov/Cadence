...
// User register sequence
	...
	class qt_test extends uvm_test;
		custom_regs_vendor_Cadence_Design_Systems_library_flat_version_2_0 model;
		...
		virtual function void build();
			...
			model=custom_regs_vendor_Cadence_Design_Systems_library_flat_version_2_0::type_id::create("model", this);
			model.build();
