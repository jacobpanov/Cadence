...
// User register sequence
	...
	class qt_test extends uvm_test;
		yapp_registers_vendor_cadence_com_library_flat_version_2_0 model;
		...
		virtual function void build();
			...
			model=yapp_registers_vendor_cadence_com_library_flat_version_2_0::type_id::create("model", this);
			model.build();
			model.set_hdl_path_root("yapp_registers");
