...
class simple_access_test extends base_test;
  ...
  virtual task run_phase (uvm_phase phase);
    ...
    `uvm_info("SIMPLE_ACCESS", "MIRROR FD ctrl_reg", UVM_NONE)
    ...
    `uvm_info("SIMPLE_ACCESS", "MIRROR FD addr0_cnt_reg", UVM_NONE)
    wrdata = 8'hf0;
...
class simple_function_test extends base_test;
  ...
  virtual task run_phase (uvm_phase phase);
    ...
    regs.en_reg.write(status, 8'b11110001);
...
class memory_access_test extends base_test;
  ...
  function void build_phase(uvm_phase phase);
      ...
      super.build_phase(phase);
      //yapp012 = yapp_012_seq::type_id::create("yapp012", this); 
      yapp1 = yapp_1_seq::type_id::create("yapp1", this); 
  endfunction : build_phase
  ...
  virtual task run_phase (uvm_phase phase);
    ...
    `uvm_info("MEM_ACCESS", "Poke 15 locations of yapp_mem", UVM_NONE)
   ...
   count = 0;
    ...
    `uvm_info("MEM_ACCESS", "Burst read yapp_mem[5:14]", UVM_NONE)
    data_dyn=new[10];
